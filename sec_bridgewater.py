...
# Get Filing Link
d = feedparser.parse('https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001350694&CIK=0001350694&type=13F-HR%25&dateb=&owner=exclude&start=0&count=40&output=atom')
...
print([k for k in [l.get("href") for l in soup.find_all("a")] if "form" in k and "xsl" in k][0])
xml_link = "https://www.sec.gov" + [k for k in [l.get("href") for l in soup.find_all("a")] if "form" in k and "xsl" in k][0]
