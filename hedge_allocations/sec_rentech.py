...
# Get Filing Link
d = feedparser.parse('https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001037389&CIK=0001037389&type=13F-HR%25&dateb=&owner=exclude&start=0&count=40&output=atom')
...
xml_link = "https://www.sec.gov" + [k for k in [l.get("href") for l in soup.find_all("a")] if "_holding.xml" in k and "xsl" in k][0]
